...
import ArrowBottom from '@/components/blocks/hero-section/arrow-bottom'
    ...
    <div className='flex max-md:flex-col max-md:space-y-8 md:items-start'>
      ...
      >
        <div className='bg-muted space-y-2.5 rounded-lg px-2.5 py-3'>
          <div className='flex items-center gap-2'>
            <img src='/images/hero-section/01.webp' alt='Docs logo' className='size-4.5' />
            <span className='text-muted-foreground text-sm'>Tone and other guidance</span>
          </div>
          <div className='flex items-center gap-2'>
            <img src='/images/hero-section/02.webp' alt='Sheets logo' className='size-4.5' />
      ...
      <div className='flex flex-col gap-8 md:gap-6'>
        ...
        >
          <div className='bg-muted space-y-2.5 rounded-lg px-2.5 py-3'>
            <div className='flex items-center gap-2'>
              <img src='/images/hero-section/03.webp' alt='LinkedIn logo' className='size-4.5' />
              <span className='text-muted-foreground text-sm'>Posted</span>
            </div>
            <div className='flex items-center gap-2'>
              <img src='/images/hero-section/04.webp' alt='x.com logo' className='size-4.5 dark:invert' />
